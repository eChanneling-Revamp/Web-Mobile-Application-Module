                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6">
                    {items.map((item) => (
                        <Link
                            key={item.id}
                            href={item.href}
                            className="relative bg-[#ebf0fa] hover:bg-white border border-blue-100 rounded-xl p-5 flex flex-col items-center justify-center text-center transition-all hover:shadow-2xl"
                        >
                            {item.isNew && (
