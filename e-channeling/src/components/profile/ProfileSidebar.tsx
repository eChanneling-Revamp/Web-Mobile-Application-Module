...
const menuItems: MenuItem[] = [
  { name: 'Appointments', href: '/profile/appoinments', icon: CalendarIcon },
  { name: 'Health-Records', href: '/profile/health-records', icon: DocumentTextIcon },
  { name: 'Payments-History', href: '/profile/payments-history', icon: CreditCardIcon },
          ...
          <div className="relative inline-block">
            ...
            <div className="inline-block">
              <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                ...
                {userData.membershipStatus === 'premium' ? 'Premium Member' : 'Free Member'}
              </span>
            </div>
          </div>
        </div>
