    ...
    <div>
      ...
      <div className="space-y-4">
        {healthRecords.map((record) => (
          <div key={record.id} className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
              {/* Appointment ID and Date/Time */}
              <div>
                <div className="mb-2">
                  <span className="text-sm font-medium text-gray-500">appointment id</span>
                  <p className="text-gray-900 font-semibold">{record.appointmentId}</p>
                </div>
                <div>
                  <span className="text-sm font-medium text-gray-500">Appointment date and time</span>
